...
namespace BinaryTree {
	...
	template <typename T>
	void straight_traverse_rec(Node<T>* root, FuncNode<T> visit) {
		if (root == nullptr) {
			return;
		}
		visit(root);
	...
	template <typename T>
	void  symmetrical_traverse_rec(Node<T>* root, FuncNode<T> visit) {
		if (root == nullptr) {
			return;
		}
	...
	template <typename T>
	void reverse_traverse_rec(Node<T>* root, FuncNode<T> visit) {
		if (root == nullptr) {
			return;
		}
	...
	template <typename T>
	void print_by_level_rec(Node<T>* root, FuncNode<T> visit) {
		if (root == nullptr) {
			return;
		}
